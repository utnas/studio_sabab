...
reddy_amissi = 	Artist.create(first_name: 'Reddy', last_name: 'Amisi', picture: "/img/StudioSabab/reddy.jpg" ,description: "Son premier tube dans Viva la Musica, Kotida, sort à la fin des années 1980. Reddy Amisi va pratiquement s\'affirmer comme un leader au sein de Viva la Musica. Ses albums assurent le succès du groupe pendant près d\'une décennie. Reddy Amisi va sortir au total huit albums au sein de ce groupe, à commencer par Zakina, son chef d\'oeuvre qui le place au firmament des hits-parades du pays. Ensuite, il largue Queen Lima, Injustice, Prudence, Fin d\'exil, Etoile, Ligne droite.")
