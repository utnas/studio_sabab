...
# Artists
Artist.create(first_name: 'Papa', last_name: 'Wemba', description: "Papa Wemba est un chanteur, compositeur et acteur congolais, un des artistes-musiciens africains les plus populaires depuis plusieurs années. Dans les années 1950, la célèbre rumba congolaise dominait le continent.<br/> Un demi-siècle plus tard, elle n'a rien perdu de sa jeunesse, même si elle a subi entre-temps de nombreux et radicaux liftings.").albums.create(title: 'Maître d\'école, rumba na rumba', picture: "", description: 'Nouvel album de Papa Wemba enregistré en partie au Studio SABAB dont la sortie est prévue mi 2013. Maître d’école bénéficiera, en featuring, de l’apport vocal de Nyoka Longo, de JB Mpiana et de la dulcinée Barbara Kanam. ')
...
Artist.create(first_name: 'Ndombe', last_name: 'Opetum', description: "L’artiste musicien Congolais Ndombe Opetum dit «Pépé Ndombe », décédé  enmai 2012 à Kinshasa, à l’âge de 68 ans. Un des monuments de la musique Congolaise moderne.").albums.create(title: 'Tendresse', picture: "", description: 'Le tout dernier album de Pépé Ndombe Opetum enregistré deux semaines avant sa mort')
Artist.create(first_name: 'Reddy', last_name: 'Amisi', description: "Son premier tube dans Viva la Musica, Kotida, sort à la fin des années 1980. Reddy Amisi va pratiquement s\'affirmer comme un leader au sein de Viva la Musica. Ses albums assurent le succès du groupe pendant près d\'une décennie. Reddy Amisi va sortir au total huit albums au sein de ce groupe, à commencer par Zakina, son chef d\'oeuvre qui le place au firmament des hits-parades du pays. Ensuite, il largue Queen Lima, Injustice, Prudence, Fin d\'exil, Etoile, Ligne droite, Likelemba.").albums.create(title: 'Encore et toujours', picture: "", description: 'Nouvel album du poète Simaro')
Artist.create(first_name: 'JB', last_name: 'Mpiana', description: "Jean-Bedel Mpiana wa Tshituka dit JB Mpiana est un auteur-compositeur-interprète kino-congolais. Il a été le président et le chanteur Vedette du groupe Wenge Musica BCBG 4x4 Tout-Terrain jusqu'à sa dislocation en décembre 1997. Il s’illustre en 1997 avec son premier album solo, Feux de l’amour, notamment avec le titre phare « Ndombolo1 », du rythme congolais très dansant.").albums.create(title: 'Chanson Primus', picture: "", description: 'Chanson publicitaire pour une bière locale. Enregistrée en live au studio SABAB, cette chanson a été mixé au studio et masterisé en France au studio Les mur des Songes à Besançon')
Artist.create(first_name: 'Jossart', last_name: 'Nyoka-Longo', description: "Zaîko Langa-Langa Nkolo Mboka").albums.create(title: 'Bande Annonce', picture: "img/albums/Zaiko-BandeAnnonce.jpg", description: 'Vimbaaaaaah Pschhhhhttt !!!!!')
...
Artist.create(first_name: 'Manda', last_name: 'Chante', description: "...").albums.create(title: '...', picture: "", description: '..')
Artist.create(first_name: 'Blaise', last_name: 'Bula', description: "...").albums.create(title: '...', picture: '', description: '')
Artist.create(first_name: 'Lola', last_name: 'Kadogo', description: "...").albums.create(title: '..', picture: '', description: '')
Artist.create(first_name: 'Franck', last_name: 'Mulaja', description: "...").albums.create(title: '...', picture: '', description: '')
Artist.create(first_name: 'Beyou', last_name: 'Ciel', description: "...").albums.create(title: '...', picture: '', description: '')
Artist.create(first_name: 'Canta', last_name: 'Niboma', description: "...").albums.create(title: '...', picture: '', description: '')
